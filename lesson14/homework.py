...
from lesson14.helpers.custom_logger import setup_logging
from lesson14.async_server import run_server
...
with cf.ThreadPoolExecutor(max_workers=REQUESTS_COUNT) as threads_executor:
    threads_executor.map(send_request)
    # pass
